      ...
      >
        ...
        >
         ...
         <v-card>
            ...
            <v-card-text>
              <Delay text="
NB:Delays to be recorded should exclude the normal operations stipulated above
(Hatch Cover,Gearbox...)
For example:Crane Breakdown/waiting for ship's crane to swing to seaside / Accident / etc..."/>
            </v-card-text>
